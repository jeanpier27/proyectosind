     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Socios</small></h1>
            </div>
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="addalquiler.php">Alquiler</a></div>
                <div class="tile-num full-reset">Alquiler</div>
            </article>   
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-calendar"></i></div>
