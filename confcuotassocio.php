     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <!-- <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor"> -->
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="generarcuotasanual.php">Seleccione</a></div>
                <div class="tile-num full-reset">Anualmente</div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-accounts"></i></div>
                <div class="tile-name all-tittles"><a href="generarcuotasindividual.php" id="addsocio">Seleccione</a></div>
                <div class="tile-num full-reset">Individualmente</div>
            </article>
