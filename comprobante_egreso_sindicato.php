...
$sqlingreso=$conexion->query("SELECT tb_egreso_sindicato.*,tb_proveedores.nombres,tb_bancos.n_cuenta,tb_bancos.banco, tb_plan_cuentas.descripcion as des FROM `tb_egreso_sindicato` inner join tb_proveedores on tb_egreso_sindicato.id_proveedor=tb_proveedores.id_proveedores inner join tb_bancos on tb_egreso_sindicato.id_banco=tb_bancos.id_banco inner join tb_plan_cuentas on tb_egreso_sindicato.id_plan_cuentas=tb_plan_cuentas.id_plan_cuentas where tb_egreso_sindicato.comprabante_n=".$id); 
