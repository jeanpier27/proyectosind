            ...
            <div class="container-flat-form">
                    ...
                    <div class="row">
                       ...
                       <?php if(isset($_GET['id'])){ 
                          $sqlupd=$conexion->query("select * from tb_pagos_socio where id_pagos_socio=".$_GET['id']); 
                      ...
                      if(isset($_POST['actualizar'])){
                        ...
                        $query="update tb_pagos_socio set valor='".$tipo."' where id_pagos_socio=".$id_per;
                        $a=$conexion->query($query);     
                        if($a){
                          echo '<script type="text/javascript">swal({title: "ok", text: "Actualizacion con exito...!", type: "success",  confirmButtonText: "Aceptar!",  closeOnConfirm: false},function(){  location.href="confsocio.php";});</script>';   
                        }else{
...
// if(isset($_GET['consultar'])){ 
    ...
    $sqlproducto=$conexion->query("select * from tb_pagos_socio"); 
                            ...
                            <table class="table table-hover table-bordered table-responsive order-table" aling="center" id="tabladatos">
                              ...
                              <?php 
                               ...
                               ?>
                                ...
                                <td><?php echo($consultasocio['id_pagos_socio']); ?></td>
                                <td><?php echo($consultasocio['descripcion']); ?></td>
                               
                                <td><?php echo($consultasocio['valor']); ?></td>
                                <th><a class="btn btn-info" href="confsocio.php?id=<?php echo $consultasocio['id_pagos_socio']; ?>"><i class="glyphicon glyphicon-pencil"></i></a></th>
...
$(document).ready(function(){
            ...
            $('#confsocio').attr("style","background-color:#E75A5A;");
