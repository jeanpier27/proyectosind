     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor">
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="addvehiculo.php">Seleccionar</a></div>
                <div class="tile-num full-reset">Registrar</div>
            </article>
            
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-truck"></i></div>
                <div class="tile-name all-tittles"><a href="consultavehiculo.php">Seleccione</a></div>
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="updatevehiculo.php">Seleccione</a></div>
                <div class="tile-num full-reset">Actualizar datos</div>
            </article>  <br>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-refresh-alt"></i></div>
                <div class="tile-name all-tittles"><a href="addmantvehiculo.php">Ingreso</a></div>
                <div class="tile-num full-reset">Mantenimiento</div>
            </article>  
