 ...
 <body>
   <script type="text/javascript">
    $(document).ready(function(){
            ...
            $('#reportedocente').attr("style","background-color:#E75A5A;");
     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Consultar Docente</small></h1>
            </div>
        </div>
        <!-- <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor"> -->
        	<div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Consulta de Docente</div>
                    <div class="row">
