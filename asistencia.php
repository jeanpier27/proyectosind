     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Asistencia</small></h1>
            </div>
        </div>
        <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor">
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-assignment-account zmdi-hc-fw"> </i></div>
                <div class="tile-name all-tittles"><a href="consult_asist_estud.php">Seleccione</a></div>
        ...
        <!-- <article class="tile">
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="asistencia_estudiantes.php">Seleccione</a></div>
            ...
            <!-- <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="updateproducto.php">Seleccione</a></div>
