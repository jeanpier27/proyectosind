     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Consultar Cofres</small></h1>
            </div>
        </div>
        <!-- <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor"> -->
        	<div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Consulta de Cofres</div>
                    <div class="row">
...
// $sqlsocio=$conexion->query("SELECT tb_inventario_historico.*,tb_producto.* FROM `tb_inventario_historico` inner join tb_producto on tb_inventario_historico.id_producto=tb_producto.id_producto WHERE date(fecha)>='".$fecha1."' and date(fecha)<='".$fecha2."'");  
// }else{
    $sqlsocio=$conexion->query("SELECT tb_inventario.*,tb_producto.* FROM `tb_inventario` inner join tb_producto on tb_inventario.id_producto=tb_producto.id_producto"); 
// }
                            ...
                            <table class="table table-hover table-bordered table-responsive order-table" aling="center" id="tabladatos">
                              ...
                              <?php 
                               ...
                               ?>
                                ...
                                <th><a class="btn btn-primary"  onClick="window.open('consultainventariodetalle.php?id_vehi=<?php echo($consultasocio['id_producto']); ?>', 'prueba', 'width=800, height=600')"><i class="glyphicon glyphicon-search"></i></a></th>
