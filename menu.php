    <div class="full-reset nav-lateral-list-menu">
        ...
        <?php if($_SESSION['tipo_usuario']=='SECRETARIO_GENERAL' or $_SESSION['tipo_usuario']=='SECRETARIO_FINANCIERO'){  ?>
          ...
          <?php } ?>
           <?php if($_SESSION['tipo_usuario']=='SECRETARIO_GENERAL' or $_SESSION['tipo_usuario']=='SECRETARIO_FINANCIERO' or $_SESSION['tipo_usuario']=='TESORERO' or $_SESSION['tipo_usuario']=='SECRETARIA' or $_SESSION['tipo_usuario']=='CONTADOR'){  ?>
             <li>
                ...
                <li><a href="usuario.php" id="usuarios"><i class="zmdi zmdi-assignment-account zmdi-hc-fw"></i>&nbsp;&nbsp; Usuarios</a></li>
         <li><a href="recursoshumanos.php" id="rh"><i class="zmdi zmdi-assignment-account zmdi-hc-fw"></i>&nbsp;&nbsp; Recursos humanos</a></li>
                </ul>
            </li>
            <?php } ?>
            <?php if($_SESSION['tipo_usuario']=='SECRETARIO_GENERAL' or $_SESSION['tipo_usuario']=='SECRETARIO_FINANCIERO' or $_SESSION['tipo_usuario']=='INSPECTOR' or $_SESSION['tipo_usuario']=='PEDAGOGO' or $_SESSION['tipo_usuario']=='DOCENTE'){  ?>
            ...
            <li>
               ...
               <?php if($_SESSION['tipo_usuario']=='SECRETARIO_GENERAL' or $_SESSION['tipo_usuario']=='SECRETARIO_FINANCIERO' or $_SESSION['tipo_usuario']=='INSPECTOR' or $_SESSION['tipo_usuario']=='PEDAGOGO'){  ?>
            ...
            <li>
             ...
             <?php if($_SESSION['tipo_usuario']=='SECRETARIO_GENERAL' or $_SESSION['tipo_usuario']=='SECRETARIO_FINANCIERO' or $_SESSION['tipo_usuario']=='INSPECTOR' or $_SESSION['tipo_usuario']=='PEDAGOGO' or $_SESSION['tipo_usuario']=='TESORERO' or $_SESSION['tipo_usuario']=='SECRETARIA' or $_SESSION['tipo_usuario']=='CONTADOR'){  ?>
        <li>
