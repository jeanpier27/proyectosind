     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> -Reporte Contable </small></h1>
            </div>
            <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-folder"></i></div>
                <div class="tile-name all-tittles"><a href="consultaresusindicato.php">Seleccione</a></div>
                <div class="tile-num full-reset">SINDICATO</div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-folder"></i></div>
                <div class="tile-name all-tittles"><a href="consultaresuescuela.php" id="addsocio">Seleccione</a></div>
