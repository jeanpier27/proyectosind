    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES DE NARANJAL <small> - Asignaturas</small></h1>
            </div>
        </div>
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="addasignatura.php">Seleccione</a></div>
                <div class="tile-num full-reset"><p style="font-size: 50%;">Registro Asignaturas</p></div>
            </article>

            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-delete"></i><i class="zmdi zmdi-time-restore"></i></div>
                <div class="tile-name all-tittles"><a href="updateasignatura.php">Seleccione</a></div>
                <div class="tile-num full-reset"><p style="font-size: 50%;">Actualizar Asignaturas</p></div>
            </article>            
