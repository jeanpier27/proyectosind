     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="consultacompsindicato.php">Socios</a></div>
                <div class="tile-num full-reset">SINDICATO</div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-folder"></i></div>
                <div class="tile-name all-tittles"><a href="consultacompescuela.php" id="addsocio">Socios</a></div>
