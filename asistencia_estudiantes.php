 ...
 <script type="text/javascript">
    $(document).ready(function(){
     ...
     <script type="text/javascript">
                                    ...
                                    location.href="asistencia_estudiantes.php?promo="+a+"&jor="+c+"&para="+d+"&mate="+f;
     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <!-- <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor"> -->
        	<div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Asistencia</div>
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-sm-offset-0 col-xs-offset-0">
                            ...
                            <table class="table table-hover table-bordered table-responsive order-table" aling="center" id="tabladatos2">
                              ...
                              if($_GET['para']!=0 and $_GET['mate']!=0){ 
                               ...
                               <td><input type="radio" name="asisten[<?php echo($consultaestudiante['id_estudiante']); ?>]" value="1" checked="checked"></td>
                               <td><input type="radio" name="asisten[<?php echo($consultaestudiante['id_estudiante']); ?>]" value="0"></td>
                          ...
                          // $Id_cur = isset($_REQUEST["cur"]) ? $_REQUEST["cur"]: 0;
                           ...
                           if($Promo!=0 and $paralelo!=0 and $Jor!="" and $Mater!=0 and $iddocente!=0){
                              ...
                              foreach ($_POST['id_estudian'] as $value) {
                                ...
                                if ($insertar_asist) {
                                 header('location: asistencia_estudiantes.php?msg=yes'); 
                               } else {
                                 header('location: asistencia_estudiantes.php?msg=no');
                               }
                             }else{
