 ...
 <?php require_once('menu.php'); ?>
     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            ...
            <!-- <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-chart"></i></div>
                <div class="tile-name all-tittles"><a href="saldos.php">Seleccione</a></div>
                <div class="tile-num full-reset">Saldos</div>
            </article> -->
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-chart"></i></div>
                <div class="tile-name all-tittles"><a href="graficoalquiler.php" id="addsocio">Seleccione</a></div>
                <div class="tile-num full-reset">Alquileres</div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-chart"></i></div>
                <div class="tile-name all-tittles"><a href="graficosindicato.php">Seleccione</a></div>
                <div class="tile-num full-reset">Sindicato</div>
            </article>  
             
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-chart"></i></div>
                <div class="tile-name all-tittles"><a href="graficoescuela.php">Seleccione</a></div>
