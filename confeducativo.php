 ...
 <body>
  <script type="text/javascript">
    $(document).ready(function(){
            ...
            $('#confeducativo').attr("style","background-color:#E75A5A;");
     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Educativo</small></h1>
            </div>
        </div>
        ...
        <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="consultaeducativo.php">Seleccione</a></div>
