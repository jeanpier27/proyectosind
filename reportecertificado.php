     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Certificados</small></h1>
            </div>
        </div>
        ...
        <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="generarcertificado.php">Seleccione</a></div>
