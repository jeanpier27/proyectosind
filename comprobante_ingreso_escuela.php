...
$sqlingreso=$conexion->query("SELECT tb_ingreso_escuela.*,tb_personas.nombre,tb_personas.apellido,tb_bancos.n_cuenta,tb_bancos.banco FROM `tb_ingreso_escuela` inner join tb_personas on tb_ingreso_escuela.id_persona=tb_personas.id_persona inner join tb_bancos on tb_ingreso_escuela.id_banco=tb_bancos.id_banco where tb_ingreso_escuela.comprabante_n=".$id); 
