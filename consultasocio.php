     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Consultar Socio</small></h1>
            </div>
        </div>
        <!-- <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor"> -->
        	<div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Consulta de Socio</div>
                    <div class="row">
...
$fecha1=substr($fecha, 0, -13);
$fecha2=substr($fecha, 13);
$sqlsocio=$conexion->query("select tb_personas.*, tb_socio.fecha_ingreso,tb_socio.fecha_naci,tb_socio.estado,tb_socio.observacion,tb_socio.beneficiario from tb_personas inner join tb_socio on tb_personas.id_persona=tb_socio.id_persona where fecha_ingreso>='".$fecha1."' and fecha_ingreso<='".$fecha2."' order by tb_personas.apellido,tb_socio.estado");   
}else{
