    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES DE NARANJAL <small> - Estudiantes</small></h1>
            </div>
        </div>
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="addestudiantes.php">Seleccione</a></div>
                <div class="tile-num full-reset"><p style="font-size: 50%;">Registro estudiantes</p></div>
            </article>

            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-delete"></i><i class="zmdi zmdi-time-restore"></i></div>
                <div class="tile-name all-tittles"><a href="updatestudiante.php">Seleccione</a></div>
                <div class="tile-num full-reset"><p style="font-size: 50%;">Actualizar estudiantes</p></div>
            </article>            

           <!--  <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-delete"></i><i class="zmdi zmdi-time-restore"></i></div>
                <div class="tile-name all-tittles"><a href="updatematricula.php">Seleccione</a></div>
                <div class="tile-num full-reset"><p style="font-size: 50%;">Actualizar Matricula</p></div>
            </article>  -->           
            ...
            <article class="tile">
             ...
             <!-- <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="">Seleccione</a></div>
                <div class="tile-num full-reset"><p style="font-size: 90%;">Psicocensometrico</p></div>
            </article> -->     
        </section>
...
if ($MSG=='ss') {
    ...
    echo '<script type="text/javascript">swal("Error!", "No se pudo registrar este estudiante", "error")</script>';
