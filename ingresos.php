     ...
     <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">SINDICATO DE CHOFERES  DE NARANJAL<small> - Ingresos</small></h1>
            </div>
        </div>
        <section class="full-reset text-center" style="padding: 10px 40PX;" id="contenedor">
          ...
          <article class="tile">
                ...
                <div class="tile-num full-reset">Socios</div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-folder"></i></div>
                <div class="tile-name all-tittles"><a href="ingreso_sindicato.php">Seleccione</a></div>
            ...
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-folder"></i></div>
                <div class="tile-name all-tittles"><a href="addpagosestudiantes.php">Seleccione</a></div>
